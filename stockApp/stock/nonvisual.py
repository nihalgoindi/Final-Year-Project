...
@app.callback([Output('model_accuracy', 'children'),
              ...
              [State('stock_dropdown', 'value'),
               ...
               State('slider', 'value')])
def update_accuracy(clicks, stock_dropdown_value, feature_dropdown_value, slider_value):
    rdm_model = forest.Forest(stock_dropdown_value, feature_dropdown_value, slider_value)
